...
![grade](./assets/0-20231219153426700.png)
...
![grade-classes](./assets/0-20231219153426648.png)
...
![class-students](./assets/0-20231219153426719.png)
...
![image-20231219160028944](./assets/image-20231219160028944.png)

从代码来看，Java 标准库自带的 JDBC 接口其实就是定义了一组接口，而某个具体的 JDBC 驱动其实就是实现了这些接口的类：

![image-20231219160128818](./assets/image-20231219160128818.png)
...
![image-20231219160147555](./assets/image-20231219160147555.png)
