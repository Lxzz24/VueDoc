...
bgImageStyle:
  ...
  opacity: 0.8
heroFullScreen: true
heroText: Lxzz's Repo
tagline: false #Welcome to my repository！
actions:
  - text: Java 教程
    icon: java
    link: ./1-Java/
...
# copyright: false
# footer: <a href="https://beian.miit.gov.cn">粤ICP备2023013392号-1</a> </span> | 使用 MIT 协议, 版权所有 © 2022-present Lxzz24
---
